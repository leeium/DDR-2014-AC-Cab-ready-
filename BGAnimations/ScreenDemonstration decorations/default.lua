...
t[#t+1] = Def.ActorFrame {
	InitCommand=cmd(x,SCREEN_CENTER_X-55-80;y,SCREEN_CENTER_Y+250+27;draworder,45);	
	-- Title
...
--song jacket--
t[#t+1] = Def.ActorFrame {
 	InitCommand=cmd(x,SCREEN_CENTER_X+431+50+10-160;y,SCREEN_CENTER_Y+250-125+10+30-15;diffusealpha,1;draworder,100);
	Def.Sprite {
