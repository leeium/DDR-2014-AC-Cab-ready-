...
t[#t+1] = LoadActor("DiffBlocks.png")..{
	InitCommand=cmd(player,PLAYER_1;vertalign,top;x,SCREEN_LEFT+14;y,SCREEN_CENTER_Y-160-43-6.5-25;zoom,0.7);
	OffCommand=cmd(linear,0.25;addx,-500);
	};
t[#t+1] = LoadActor("DiffBlocks.png")..{
	InitCommand=cmd(player,PLAYER_2;vertalign,top;x,SCREEN_RIGHT-14;y,SCREEN_CENTER_Y-160-43-6.5-25;zoom,0.7);
	OffCommand=cmd(linear,0.25;addx,500);
	};	
...
t[#t+1] = LoadActor("GRP1")..{
	InitCommand=cmd(x,SCREEN_LEFT+260-15-40;y,SCREEN_CENTER_Y-80;player,PLAYER_1;draworder,-1;diffusealpha,0.8;zoom,0.96);
	OffCommand=cmd(bouncebegin,0.25;zoom,0);
	};
t[#t+1] = LoadActor("GRP2")..{
	InitCommand=cmd(x,SCREEN_RIGHT-260+15+40;y,SCREEN_CENTER_Y-80;player,PLAYER_2;draworder,-1;diffusealpha,0.8;zoom,0.96);
	OffCommand=cmd(bouncebegin,0.25;zoom,0);
	};
--default radar
...
t[#t+1] = LoadFont("ScreenSelectMusic meter") .. {
	InitCommand=cmd(x,SCREEN_LEFT+260-15-40;y,SCREEN_CENTER_Y-100;player,PLAYER_1;diffuse,color("#000000"));
	OffCommand=cmd(bouncebegin,0.25;zoom,0);
...
--descriptionP1
t[#t+1] = LoadFont("ScreenSelectMusic meter") .. {
	InitCommand=cmd(x,SCREEN_LEFT+260-15-40;y,SCREEN_CENTER_Y-190-13;player,PLAYER_1;diffuse,color("#000000");zoom,0.575;maxwidth,480;shadowlengthy,3);
	OffCommand=cmd(bouncebegin,0.25;zoom,0);
	CurrentSongChangedMessageCommand=cmd(queuecommand,"Set");
	CurrentStepsP1ChangedMessageCommand=cmd(queuecommand,"Set");
	SetCommand=function(self)
...
--Meterp2
t[#t+1] = LoadFont("ScreenSelectMusic meter") .. {
	InitCommand=cmd(x,SCREEN_RIGHT-260+15+40;y,SCREEN_CENTER_Y-100;player,PLAYER_2;diffuse,color("#000000"));
	OffCommand=cmd(bouncebegin,0.25;zoom,0);
	CurrentSongChangedMessageCommand=cmd(queuecommand,"Set");
...
--descriptionP2
t[#t+1] = LoadFont("ScreenSelectMusic meter") .. {
	InitCommand=cmd(x,SCREEN_RIGHT-260+15+40;y,SCREEN_CENTER_Y-190-13;player,PLAYER_2;diffuse,color("#000000");zoom,0.575;maxwidth,480;shadowlengthy,3);
	OffCommand=cmd(bouncebegin,0.25;zoom,0);
	CurrentSongChangedMessageCommand=cmd(queuecommand,"Set");
	CurrentStepsP2ChangedMessageCommand=cmd(queuecommand,"Set");
	SetCommand=function(self)
...
t[#t+1] = LoadActor("Information.png")..{
		InitCommand=cmd(x,SCREEN_RIGHT-185;y,SCREEN_CENTER_Y-90;visible,GAMESTATE:IsHumanPlayer(PLAYER_1);diffusealpha,0.8;zoom,0.8);
...
t[#t+1] = LoadActor("Information.png")..{
		InitCommand=cmd(x,SCREEN_LEFT+185;y,SCREEN_CENTER_Y-90;visible,GAMESTATE:IsHumanPlayer(PLAYER_2);diffusealpha,0.8;zoom,0.8);
		OnCommand=function(self)
			local style = GAMESTATE:GetCurrentStyle():GetStyleType()
			if style == "StyleType_TwoPlayersTwoSides" then
				self:diffusealpha(0);
...
t[#t+1] = LoadActor("PaneNumbers")..{
		InitCommand=cmd(x,SCREEN_RIGHT-351+100+12+6-60-40+2+15;y,SCREEN_CENTER_Y-90-164-20+10;diffusealpha,0;zoom,0.85;draworder,2;player,PLAYER_2;animate,false);
		CodeMessageCommand=function(self,params)
		local style = GAMESTATE:GetCurrentStyle():GetStyleType()
		local pn= params.PlayerNumber
		if pn==PLAYER_2 then
...
t[#t+1] = LoadActor("radarP1")..{
		InitCommand=cmd(diffusealpha,0;draworder,3;addy,-23;addx,-5);
...
t[#t+1] = LoadActor("radarP2")..{
		InitCommand=cmd(diffusealpha,0;draworder,3;addy,-23;addx,50);
		CurrentSongChangedMessageCommand=function(self)
		local song = GAMESTATE:GetCurrentSong()
			if song then
				self:zoom(1.1);
...
--song jacket border
t[#t+1] = Def.Quad{
	InitCommand=cmd(CenterX;y,SCREEN_CENTER_Y-110-5-15-8-44;diffusealpha,1;draworder,1;diffuse,color("#000000");setsize,224,224);
...
t[#t+1] = Def.ActorFrame {
 	InitCommand=cmd(CenterX;y,SCREEN_CENTER_Y-110-5-15-8-44;diffusealpha,1;draworder,1);
	OffCommand=cmd(sleep,0.2;bouncebegin,0.175;zoomy,0);
	Def.Banner {
		SetCommand=function(self)
		if not GAMESTATE:IsCourseMode() then
		local song = GAMESTATE:GetCurrentSong();
				if song then
					if song:HasJacket() then
						...
						self:zoomtowidth(220);
						self:zoomtoheight(220);							
...
InitCommand=cmd(addy,-110);
	Def.Quad{
	InitCommand=cmd(zoom,0.8;shadowlength,1;x,SCREEN_CENTER_X-75;y,SCREEN_CENTER_Y+100;horizalign,center;draworder,2);
