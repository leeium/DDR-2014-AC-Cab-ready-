return Def.ActorFrame{
	...
	LoadActor( "DDR2013_logo" )..{
		...
		OnCommand=cmd(diffusealpha,0;sleep,0.25;linear,0.6;zoom,0.75;diffusealpha,1;sleep,1);
	};

	LoadActor( "DDR2013_logo" )..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y;),
		OnCommand=cmd(diffusealpha,0;playcommand,"Animate");
		AnimateCommand=cmd(zoom,0.75;sleep,1.5;linear,0.5;zoom,0.75;blend,'BlendMode_Add';diffusealpha,0.8;decelerate,2.7;zoom,1.5;diffusealpha,0;sleep,10;queuecommand,"Animate");
	...
	LoadActor( "DDR2013_Blend.png" )..{
		...
		AnimateCommand=cmd(zoom,0.75;diffusealpha,0;accelerate,0.8;zoom,0.75;diffusealpha,0.6;
		decelerate,0.8;zoom,0.75;diffusealpha,0;sleep,0.5;queuecommand,"Animate");
